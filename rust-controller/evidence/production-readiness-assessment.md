...
The current PR head is `b44fa4ac` (verified 2026-09-11). GitHub reports the
...
`d0297079`/`daeb5a52`, followed by atomic response capture at
`ad16c5a2`/`b44fa4ac`, are evidence for the validated fact
