...
Current scope at `a50d6a6f`: this branch and PR #65 contain an accumulated
...
The current PR head is `a50d6a6fbecb18a285cc913f74472105a89b1963` (verified 2026-09-11). The exact-source
