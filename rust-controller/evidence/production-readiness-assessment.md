...
The current PR head is `ed8f3d4d` (verified 2026-09-11). GitHub reports the
...
and legacy-provenance proof at `c7b1bde5`/`ed8f3d4d`, are evidence for the validated fact
