#!/usr/bin/env bash
# Build the seed AutopilotAgent executable in a Docker .NET SDK container.
...
VERSION="${AUTOPILOT_AGENT_VERSION:-0.1.2}"
...
echo "[agent-seed] building ${RID_LIST} with ${SDK_IMAGE}"
docker run --rm \
