...
DEFAULT_LIMITS = [
    ...
    ("cloudosd_cache_refresh_catalog", 1),
    ("cloudosd_cache_feature_image", 2),
    ("cloudosd_cache_quality_update", 2),
    ("provision_cloudosd", 4),
    ("osdeploy_build_iso", 1),
    ("osdeploy_cache_refresh_catalog", 1),
    ("osdeploy_cache_warm", 2),
    ("osdeploy_cache_verify", 2),
    ("osdeploy_cache_delete", 1),
